...
export interface HeroSearchBannerProps {}

const HeroSearchBannerStyled = styled.div`
  height: 80vh;
...
const HeroSearchBanner: React.FunctionComponent<HeroSearchBannerProps> = () => {
  return (
    <HeroSearchBannerStyled className="relative overflow-hidden mb-24 flex justify-center bg-white bg-cover bg-fixed">
      <PartyAnimation className="w-full h-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 " />
